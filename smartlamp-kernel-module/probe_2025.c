...
#define VENDOR_ID   0x10C4 /* <-- Esse hexadecimal é um placeholder. Encontre o VendorID  do smartlamp */
#define PRODUCT_ID  0xEA60 /* <-- Esse hexadecimal é um placeholder. Encontre o ProductID do smartlamp */
